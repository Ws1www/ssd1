...
def main(parser_data):
    ...
    train_dataset = VOCDataSet(VOC_root, data_transform['train'], train_set='train.txt')
    ...
    val_dataset = VOCDataSet(VOC_root, data_transform['val'], train_set='val.txt')
...
if __name__ == '__main__':
    ...
    # 训练数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='yg', help='dataset')
    # 文件保存地址
